  ...
  return (
    <div
      ...
      className={`relative md:top-0 overflow-hidden  cursor-pointer ${
        size === "md"
          ? "text-xl text-center  h-[30px] 2xl:h-[3vh]  w-[20vh]"
          : size === "lg"
    ...
    >
      ...
      {size === "md" ? (
        <>
          <span
            className={`absolute inset-0 h-full ${color} inline-block transition-transform text-center justify-center 
        ${hovered ? `-translate-y-full ` : "translate-y-0 "} duration-300`}
          ...
          <span
            className={`absolute inset-0  inline-block transition-transform text-center justify-center ${color} duration-300 ${
